...
def calculate_spl_rt_diffusion(k,length,width,height,x_source,y_source,z_source,x_rec,y_rec,z_rec,alpha):
    ...
    alpha_1 = alpha #Absorption coefficient for Surface1 - Floor
    alpha_2 = alpha #Absorption coefficient for Surface2 - Ceiling
    alpha_3 = alpha #Absorption coefficient for Surface3 - Wall Front
    alpha_4 = alpha #Absorption coefficient for Surface4 - Wall Back
    alpha_5 = alpha #Absorption coefficient for Surface5 - Wall Left
    alpha_6 = alpha #Absorption coefficient for Surface6 - Wall Right
